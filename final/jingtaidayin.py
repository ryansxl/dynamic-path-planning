...
plt.text(-45, 140, 'airplane:CA405', color=color1)
plt.text(-45, 135, 'airplane:3U8849', color=color2)
plt.text(-45, 130, 'airplane:CZ3183', color=color3)
plt.text(-45, 125, 'airplane:PN6237', color=color5)
plt.text(-45, 120, 'airplane:3U8741', color=color7)
plt.text(-45, 115, 'airplane:CA2158', color=color8)


plt.text(-45, 110, 'airplane:CA1419', color=color4)
plt.text(-45, 105, 'airplane:3U8935', color=color6)
plt.text(-45, 100, 'airplane:3U8633', color=color9)
plt.text(-45, 95, 'airplane:CA4123', color=color10)

chang1=[]
path1= shortest_path(airports, 'w1', 'h', pos)
showpath(airports, path1, pos, color1)
lenth1=0.00
...
for index in range (len(path1)-1) : 
		...
		lenth1=lenth1+mmm
		chang1.append(lenth1)
		print(path1[index],lenth1)

chang2=[]
path2= shortest_path(airports, 'b', 'r1', pos)
showpath(airports, path2, pos, color2)
lenth2=0.00
...
for index in range (len(path2)-1) : 
		...
		lenth2=lenth2+mmm
		chang2.append(lenth2)
		print(path2[index],lenth2)

chang3=[]
path3= shortest_path(airports, 'k', 'r1', pos)
showpath(airports, path3, pos, color3)
lenth3=0.00
...
for index in range (len(path3)-1) : 
		...
		lenth3=lenth3+mmm
		chang3.append(lenth3)
		print(path3[index],lenth3)


chang4=[]
path4= shortest_path(airports, 'w1', 'i', pos)
showpath(airports, path4, pos, color4)
lenth4=0.00
...
for index in range (len(path4)-1) : 
		...
		lenth4=lenth4+mmm
		chang4.append(lenth4)
		print(path4[index],lenth4)


chang5=[]
path5= shortest_path(airports, 'g', 'r1', pos)
showpath(airports, path5, pos, color5)
lenth5=0.00
...
for index in range (len(path5)-1) : 
		...
		lenth5=lenth5+mmm
		chang5.append(lenth5)
		print(path5[index],lenth5)


chang6=[]
path6= shortest_path(airports, 'w1', 'i', pos)
showpath(airports, path6, pos, color6)
lenth6=0.00
...
for index in range (len(path6)-1) : 
		...
		lenth6=lenth6+mmm
		chang6.append(lenth6)
		print(path6[index],lenth6)


chang7=[]
path7= shortest_path(airports, 'g', 'r1', pos)
showpath(airports, path7, pos, color7)
lenth7=0.00
...
for index in range (len(path7)-1) : 
		...
		lenth7=lenth7+mmm
		chang7.append(lenth7)
		print(path7[index],lenth7)


chang8=[]
path8= shortest_path(airports, 'g', 'r1', pos)
showpath(airports, path8, pos, color8)
lenth8=0.00
...
for index in range (len(path8)-1) : 
		...
		lenth8=lenth8+mmm
		chang8.append(lenth8)
		print(path8[index],lenth8)



chang9=[]
path9= shortest_path(airports, 'w1', 'h', pos)
showpath(airports, path9, pos, color9)
lenth9=0.00
...
for index in range (len(path9)-1) : 
		...
		lenth9=lenth9+mmm
		chang9.append(lenth9)
		print(path9[index],lenth9)


chang10=[]
path10= shortest_path(airports, 'w1', 'f', pos)
showpath(airports, path10, pos, color10)
lenth10=0.00
...
for index in  range(len(paths))  :
	print(paths[index])
	print(max(lenths[index]))


plt.text(115, -15 , 'time = 0  s', color='k')
